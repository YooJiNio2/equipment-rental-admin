...
import { Ionicons } from '@expo/vector-icons'; //알림을 위한 아이콘
...
export default function AdminScreen() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.cardRow}>
        ...
        <TouchableOpacity style={[styles.card, { backgroundColor: '#FF4D4D' }]}>
  ...
  <View style={styles.emptyCard} />
      ...
      <View style={styles.activityBox}>
        <Text style={styles.activityText}>[대여] 김학생 (2022...) - 아두이노 키트 01 (방금 전)</Text>
        <View style={styles.divider} />
        <Text style={styles.activityText}>[반납] 이영희 (2023...) - 맥북에어 05 (5분 전)</Text>
        <View style={styles.divider} />
        <Text style={styles.activityText}>[대여] 박철수 (2024...) - 라즈베리 파이 (10분 전)</Text>
      </View>
    </ScrollView>
  );
}
